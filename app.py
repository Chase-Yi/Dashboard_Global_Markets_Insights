...
if __name__ == "__main__":
        ...
        app.layout = html.Div([
            ...
            html.Div([
                ...
                columns=[{'id': c, 'name': c,
                'presentation': 'markdown', 'selectable': True} for c in index_etf_ticker_name.columns],
                ...
                columns=[{'id': c,'name': c, "selectable": True} for c in close_volume_hist_with_ticker.columns],
        ...
        def Update_ETF_Graphs(etf_selected,date_selected):
            ...
            y=date_selected,
            color='Name',
            template='plotly_dark',height=800,width=1500,labels={date_selected:'Return %','x':'Name'},
            ...
            theta='holdingName',line_close=True,template='plotly_dark',height=800,width=1500,markers=True,
            ...
            title=etf_selected+': '+'Sector Weightings',template='plotly_dark',height=800,width=1500)
